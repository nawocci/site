    ...
    <li className={cardClassName} style={{ animationDelay: `${index * 75}ms` }}>
      ...
      >
        <div className="relative h-48 sm:h-48 lg:h-52 overflow-hidden bg-border">
          {imageUrl ? (
            ...
            <div className="hero-fallback-gradient relative h-full w-full flex items-center justify-center">
              ...
              <p className="z-[10] text-xs font-semibold tracking-wide text-muted-foreground">
        ...
        <div className="flex grow flex-col p-3 sm:p-4 space-y-2 transition-colors duration-200">
          <time
            dateTime={dateTime}
            className="inline-flex w-fit self-start whitespace-nowrap rounded-full bg-primary/10 px-3 py-1 text-xs font-semibold text-primary tabular-nums transition-colors duration-200 sm:text-sm lg:text-base"
          >
            {displayDate}
          </time>
