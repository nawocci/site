    ...
    <div className="w-full h-full flex flex-col justify-center items-center gap-6">
      ...
      <div className="flex gap-5 mt-8">
        <a 
          ...
          download
          className="flex items-center justify-center gap-2 px-6 py-3 border border-white text-white rounded-lg font-medium hover:border-primary hover:text-primary duration-200"
        >
