        ...
        <section className="relative w-full overflow-hidden font-mono sm:rounded-3xl sm:border sm:border-border sm:bg-background sm:p-7 motion-scale-in">
          ...
          <div className="hidden sm:block">
            <div className="space-y-6">
              <p
                className="motion-fade-up text-xs uppercase text-foreground/60"
                style={{ letterSpacing: "0.2em" }}
              >
                profile.md
              </p>
              <div className="rounded-2xl border border-border bg-background p-7 motion-fade-up motion-delay-1">
                ...
                <p className="mt-5 max-w-3xl text-lg leading-relaxed text-foreground/80 motion-fade-up motion-delay-3">
                  {bioText}
                </p>
              </div>
            ...
            <div className="space-y-4 rounded-2xl border border-border bg-background p-4">
              ...
              <div className="flex flex-col gap-2.5">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-foreground px-4 py-3 text-sm font-semibold text-background shadow-md transition-all duration-200 hover:bg-primary hover:shadow-lg active:scale-[0.98]"
                >
                  Download CV
                  <FiDownload className="h-4 w-4" />
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex w-full items-center justify-center gap-2 rounded-xl border-2 border-border px-4 py-3 text-sm font-semibold text-foreground transition-all duration-200 hover:border-primary hover:text-primary active:scale-[0.98]"
                >
                  View Projects
                  <FiGithub className="h-4 w-4" />
                </a>
